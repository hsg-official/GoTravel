        ...
        async function fetchGuides() {
            ...
            try {
                ...
                guides.forEach(guide => {
                    ...
                    const location = guide.city || guide.location || "Sri Lanka";
                    const desc = guide.description || "Expert local guide ready to show you the best spots.";
                    const price = guide.price ? `Rs. ${guide.price}` : "Price strictly negotiable";
                    const photo = guide.photo_url || "https://images.unsplash.com/photo-1544717305-2782549b5136?q=80&w=600&auto=format&fit=crop";
                    const guideEmail = guide.email || "guide@example.com"; 
                    
                    // NEW: Extract contact number (Checking common column names you might have used)
                    const contactNo = guide.contact || guide.contact_number || guide.phone || "Number not provided";
                    ...
                    card.innerHTML = `
                        ...
                        <div class="guide-info">
                            ...
                            <p class="guide-desc">${desc.substring(0, 80)}...</p>
                            ...
                            <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.2); padding: 10px; border-radius: 8px; margin-bottom: 15px;">
                                ...
                                <div style="font-size: 0.75rem; color: var(--text-muted); font-style: italic;">
                                    * Please call for more information and to negotiate availability.
                                </div>
                            </div>
